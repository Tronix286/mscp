...
rem zcc +cpm -compiler=sdcc -pragma-define:CRT_ENABLE_COMMANDLINE=0 -pragma-define:CRT_COMMANDLINE_REDIRECTION=0 -pragma-define:CRT_OPEN_MAX=1 -DLOAD_BOOK_BIN -DPROFILE -Cs"--disable-warning 85" --list -m mscp.c -o mscp.com
